import {
  ...
  Activity, Image, PenTool, Building2,
  CheckSquare,
} from 'lucide-react';
...
export const ORG_SIDEBAR_CONFIG: SidebarItem[] = [
  // ── MAIN ──────────────────────────────────────────────────────────────
  {
    id: 'dashboard',
    label: 'Dashboard',
  ...
  // ── PROGRAMMES ─────────────────────────────────────────────────────────
  {
    ...
    section: 'Programmes',
    children: [
      { label: 'All Programmes',   href: '/dashboard/programs',               permission: PERMISSIONS.VIEW_PROGRAMS },
      { label: 'Create Programme', href: '/dashboard/programs?action=create', permission: PERMISSIONS.MANAGE_PROGRAMS },
    ],
  },
  {
    id: 'activities',
  ...
  // ── SYSTEM ────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { label: 'Organisations',      href: '/dashboard/admin/organizations',           permission: PERMISSIONS.MANAGE_ORGANIZATION },
    ],
  },
];
